...
Both branches above: if you want to see test results in the Tests widget then remove -DskipResults in the build job of each branch. Creating the test results takes a bit of time.   
